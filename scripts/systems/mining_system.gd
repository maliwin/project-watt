...
func attempt_mine_tile(tile_pos: Vector2i, tool: MiningTool):
    ...
    var tile_hardness = Systems.world.current_planet.get_total_hardness(tile_data)
    ...
    Systems.world.destroy_tile(tile_pos)
